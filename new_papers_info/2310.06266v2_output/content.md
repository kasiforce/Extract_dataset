...
that CodeFuse-13B achieves a HumanEval pass@1 score of 37.10%,
...
Pass@1
Mar 2023
CodeFuse-1.3B-2K Seq-Length
11.58%
Apr 2023
CodeFuse-6.5B-4K Seq-Length
20.46%
May 2023
CodeFuse-13B-Base-4K Seq-Length
32.93%
Jun 2023
CodeFuse-13B (opened in Sep)
37.10%
Sep 2023
CodeFuse-CodeLlama-34B (opened)
74.40%
...
similar languages that can negatively impact the model’s training
effectiveness.
...
𝑥𝑡+1
=
𝑥𝑡+ 𝐹𝐹𝑁(𝐿𝑁(𝑥𝑡+ 𝐴𝑡𝑡𝑛(𝐿𝑁(𝑥𝑡))))
(1)
𝑥𝑡+1
=
𝑥𝑡+ 𝐴𝑡𝑡𝑛(𝐿𝑁(𝑥𝑡)) + 𝐹𝐹𝑁(𝐿𝑁(𝑥𝑡))
(2)
...
4.4
Evaluation on multi-lingual code translation
...
scenarios.
4.5
Evaluation on code-related tasks with
Chinese prompts
...
tion provided by Nvidia TensorRT-LLM 5; (3) performing service
...
generation with AlphaCode. Science 378, 6624 (dec 2022), 1092–1097.
https:
...
1109/SCAM.2007.31
[26] Erik Nijkamp, Bo Pang, Hiroaki Hayashi, et al. 2023.
CodeGen: An
...
[45] Yue Wang, Hung Le, Akhilesh Deepak Gotmare, et al. 2023.
CodeT5+:
...
[52] Qinkai Zheng, Xiao Xia, Xu Zou, et al. 2023.
...
IEEE, 110–121.
[55] Xin Zhou, Kisub Kim, Bowen Xu, et al. 2023.
The Devil is in the
